...
export default function NotificationDropdown({ close }) {
  ...
  if (!notifications.length) {
    return (
      <div className="absolute right-0 top-14 w-96 max-w-[calc(100vw-2rem)] bg-slate-900 border border-slate-700 rounded-xl shadow-2xl p-6">
  ...
  return (
    <div className="absolute right-0 top-14 w-96 max-w-[calc(100vw-2rem)] bg-slate-900 border border-slate-700 rounded-xl shadow-2xl overflow-hidden">
        ...
        {notifications.slice(0, 5).map((notification) => (
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-slate-400 text-sm mt-1">{notification.body}</p>
